...
\begin{document}
	...
	\begin{frame}
		...
		\begin{itemize}
			...
			\item Joey McCollum and Robert Turnbull, \textquote{Using Bayesian Phylogenetics to Infer Manuscript Transmission History}, \emph{Digital Scholarship in the Humanities} (in revision)
